...
const Projects = () => {
  ...
  useEffect(() => { 
    audioRef.current.src = myProjects[selectedProjectIndex].texture; 
    if (isMuted) 
        { audioRef.current.muted = true; } 
    else 
        { audioRef.current.muted = false; audioRef.current.play(); } 
    }, [selectedProjectIndex, isMuted]);
          ...
          <Canvas>
            ...
            <Center>
              <Suspense fallback={<CanvasLoader />}>
                <group scale={3} position={[-0.4, -5.5, 0]} rotation={[0, -0.1, 0]}>
